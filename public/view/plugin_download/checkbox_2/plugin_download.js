			...
			first_type: [
				{
					...
					show: true,
					plugin: [
						{ name: '折线图', route: '/route/plugin_download/Chart_1', active: true },
						{ name: '直方图', route: '/route/plugin_download/Chart_2', active: false },
						{ name: '饼状图', route: '/route/plugin_download/Chart_3', active: false },
						{ name: '散点图', route: '/route/plugin_download/Chart_4', active: false },
						{ name: '雷达图', route: '/route/plugin_download/Chart_5', active: false }
					]
				},
				{
					first_name: '缓冲动画',
					show: false,
					plugin: [
						{ name: '泡泡动画', route: '/route/plugin_download/Animation_1', active: false },
						{ name: '方块动画', route: '/route/plugin_download/Animation_2', active: false },
						{ name: '圆环动画', route: '/route/plugin_download/Animation_3', active: false },
						{ name: '闪烁动画', route: '/route/plugin_download/Animation_4', active: false },
						{ name: '水滴动画', route: '/route/plugin_download/Animation_5', active: false },
						{ name: '线动画', route: '/route/plugin_download/Animation_6', active: false }
					]
				},
				{
					first_name: '轮播图',
					show: false,
					plugin: [
						{ name: '常用轮播图', route: '/route/plugin_download/Carousel_1', active: false },
						{ name: '水平旋转', route: '/route/plugin_download/Carousel_2', active: false },
						{ name: '垂直轮播图', route: '/route/plugin_download/Carousel_3', active: false },
						{ name: '3d轮播图', route: '/route/plugin_download/Carousel_4', active: false }
					]
				},
				{
					first_name: '分页',
					show: false,
					plugin: [
						{ name: '常见', route: '/route/plugin_download/Page_1', active: false },
						{ name: '酷炫', route: '/route/plugin_download/Page_2', active: false }
					]
				},
				{
					first_name: '选择框',
					show: false,
					plugin: [
						{ name: '常见', route: '/route/plugin_download/Checkbox_1', active: false },
						{ name: '方形', route: '/route/plugin_download/Checkbox_3', active: false },
						{ name: '眼睛', route: '/route/plugin_download/Checkbox_4', active: false },
						{ name: '心形', route: '/route/plugin_download/Checkbox_5', active: false }
					]
				},
				{
					first_name: '日期选择',
					show: false,
					plugin: [
						{ name: '日历', route: '/route/plugin_download/Date_1', active: false },
						{ name: '年月日', route: '/route/plugin_download/Date_2', active: false }
					]
				},
				{
					first_name: '折叠',
				...
				},
				{
					...
					show: false,
					plugin: [
						{ name: '普通', route: '/route/plugin_download/Progress_2', active: false },
						{ name: '横向拖动', route: '/route/plugin_download/Progress_1', active: false },
						{ name: '圆环', route: '/route/plugin_download/Progress_3', active: false }
					]
				},
				{
					first_name: '开关',
					show: false,
					plugin: [
						{ name: '3D按钮开关', route: '/route/plugin_download/Switch_3', active: false },
						{ name: '3D开关', route: '/route/plugin_download/Switch_2', active: false },
						{ name: '普通开关', route: '/route/plugin_download/Switch_1', active: false }
					]
				},
				{
					first_name: '地址',
				...
				},
				{
					first_name: '菜单树',
					show: false,
					plugin: [{ name: '树组件', route: '/route/plugin_download/Tree_1', active: false }]
				},
				{
					first_name: '颜色选择器',
					show: false,
