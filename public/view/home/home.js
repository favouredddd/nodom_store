...
var partical = {
	...
	init: function() {
		...
		if (!me.canvasct || !me.canvas1 || !me.canvas2) {
			console.log(12121)
			return
		}
		me.css_set()
		...
		Img.src = '/plugin_set/public/img/home.png'
	},
	//配置一些在插件中更改的样式
	config: function() {
		var me = this
	...
	getpoint: function() {
		var me = this
		me.canvas2 = document.createElement('canvas')
		me.canvas2.setAttribute('height', me.height)
		me.canvas2.setAttribute('width', me.width)
...
;(function() {
	DD.createModule({
		...
		data: {
			...
			from: '技术支持 By 雷创科技&web技术实验室 2018',
